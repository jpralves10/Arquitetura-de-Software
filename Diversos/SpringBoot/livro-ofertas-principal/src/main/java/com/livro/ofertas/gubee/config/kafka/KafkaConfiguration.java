package com.livro.ofertas.gubee.config.kafka;
...
public class KafkaConfiguration {
    ...
    public ProducerFactory<String, KafkaModel> producerFactory(){
        ...
        config.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, KAFKA_ENV);
    ...
    public ConsumerFactory<String, KafkaModel> consumerFactory() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, KAFKA_ENV);
